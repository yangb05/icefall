...
from asr_datamodule import RuAsrDataModule
...
def run(rank, world_size, args):
    ...
    ruopenstt = RuAsrDataModule(args)
    train_cuts = ruopenstt.train_cuts()
    ...
    train_dl = ruopenstt.train_dataloaders(
        train_cuts, sampler_state_dict=sampler_state_dict
    )

    valid_cuts = ruopenstt.dev_cuts()
    valid_dl = ruopenstt.valid_dataloaders(valid_cuts)
...
def main():
    parser = get_parser()
    RuAsrDataModule.add_arguments(parser)
